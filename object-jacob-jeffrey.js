...
// const pbSandwhich = (lunch) => {
//     return `the ingedients for a ${lunch.name} ${lunch.type} are ${lunch.ingredients}`
// 
// console.log(pbSandwhich(lunch))
