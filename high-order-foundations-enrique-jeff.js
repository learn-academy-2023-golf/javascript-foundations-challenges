...
// pseudoCode
// declare a function named onlyLetters
// input: takes in an array
// output: a string with only letters saying "nicework"
// use .filter to filter for letters 
// use typeof operator
...
//psudoCode
//declare a function called wantedValues
//input: array "filterArrayValues"
//output: not false, null, 0, or blank values
//use .filter
//use high order function .filter

// const filterArrayValues = [58, "", "abcd", true, null, false, 0]
// // // output: [58, "abcd", true]

// const wantedValues = (array) => {
//     return array.filter(value => value !== false && value !== null && value !==  0 && value !==  "")
// }
// console.log(wantedValues(filterArrayValues))
...
//pseudo code
//declare a function called camelLetters
//input: array "makesWackyWords"
//output: an array of strings with every other letter capitalized
//use .toUpperCase
//use .map to iterate the elements of the array

const camelLetters = (array) => {
    return array.map(value => value[2,4,6].toUpperCase)
}
console.log(camelLetters(makesWackyWords))
